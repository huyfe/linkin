...
router.get('/user-deleted/:email', userController.TrashUser);
...
router.get('/checkrestoreuser/:email/user', userController.CheckRestore);
...
router.patch('/restore-user/:email', userController.RestoreUser);
