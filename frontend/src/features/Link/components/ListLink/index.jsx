...
function ListLink(props) {
    ...
    const linkList = linkListData.map(link => {
        return (
            <LinkItem key={link._id} title={link.title} urlPost={link.link ? link.link : '/'} urlLink={link.link ? link.link : '/'} image={link.image} date={link.created_date} public={link.public} />
        )
    })
